...
final dashboardRouter = GoRouter(routes: [
  ...
  GoRoute(path: '/incident/:id', builder: (context, state) { final id = state.pathParameters['id'] == null ? '' : state.pathParameters['id'].toString(); return IncidentDetailScreen(incidentId: id); }),
